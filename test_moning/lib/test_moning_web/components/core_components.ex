defmodule TestMoningWeb.CoreComponents do
  @moduledoc """
  ...
  within your compiled app.css by the plugin in your `assets/`.
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TestMoningWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TestMoningWeb.Gettext, "errors", msg, opts)
    end
  end
